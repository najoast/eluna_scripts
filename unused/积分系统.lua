...
local ItemEntry=199019 --用于使用后查看积分并兑换的物品entry。 ps 其实可以整合到什么超级炉石那里的，所选用的物品必须带技能的能使用的。
local jf_entry=60000 --代表积分的物品可以叫某某货币之类的,本来想直接加在数据库值然后读取的 不过兑换东西的时候太麻烦，所以还是做成了物品容易用于兑换。
local jf_mins=3 --设置每多少分钟得到1点积分。
