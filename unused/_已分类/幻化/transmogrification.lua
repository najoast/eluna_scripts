...
print("Loading Transmogrification Script")

local NPC_Entry = 150150  --幻化NPC可以自行修改
...
local SlotNames = {
    [EQUIPMENT_SLOT_HEAD      ] = {"Head",         nil, nil, nil, "头部", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_SHOULDERS ] = {"Shoulders",    nil, nil, nil, "肩部", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BODY      ] = {"Shirt",        nil, nil, nil, "衬衫", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_CHEST     ] = {"Chest",        nil, nil, nil, "胸部", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WAIST     ] = {"Waist",        nil, nil, nil, "腰带", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_LEGS      ] = {"Legs",         nil, nil, nil, "腿部", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_FEET      ] = {"Feet",         nil, nil, nil, "鞋子", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WRISTS    ] = {"Wrists",       nil, nil, nil, "手腕", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_HANDS     ] = {"Hands",        nil, nil, nil, "手套", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BACK      ] = {"Back",         nil, nil, nil, "背部", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_MAINHAND  ] = {"Main hand",    nil, nil, nil, "主手武器", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_OFFHAND   ] = {"Off hand",     nil, nil, nil, "副手武器", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_RANGED    ] = {"Ranged",       nil, nil, nil, "远程武器", nil, nil, nil, nil},
    [EQUIPMENT_SLOT_TABARD    ] = {"Tabard",       nil, nil, nil, "战袍", nil, nil, nil, nil},
}
local Locales = {
    {"Update menu", nil, nil, nil, "刷新", nil, nil, nil, nil},
    {"Remove all transmogrifications", nil, nil, nil, "清除所有幻化效果", nil, nil, nil, nil},
    {"Remove transmogrifications from all equipped items?", nil, nil, nil, "你确认要清除所有已装备的幻化效果吗？", nil, nil, nil, nil},
    {"Using this item for transmogrify will bind it to you and make it non-refundable and non-tradeable.\nDo you wish to continue?", nil, nil, nil, "幻化后将会使装备绑定，使其无法退回或者交易。\n你确认要幻化吗？", nil, nil, nil, nil},
    {"Remove transmogrification from %s?", nil, nil, nil, "你确定要清除%s上的幻化效果吗？", nil, nil, nil, nil},
    {"Back..", nil, nil, nil, "后退", nil, nil, nil, nil},
    {"Remove transmogrification", nil, nil, nil, "清除幻化效果", nil, nil, nil, nil},
    {"Transmogrifications removed from equipped items", nil, nil, nil, "所有的幻化效果都已经清除", nil, nil, nil, nil},
    {"You have no transmogrified items equipped", nil, nil, nil, "你没有幻化的装备正在佩戴，无需清除", nil, nil, nil, nil},
    {"%s transmogrification removed", nil, nil, nil, "%s的幻化效果已被清除", nil, nil, nil, nil},
    {"No transmogrification on %s slot", nil, nil, nil, "%s目前没有被幻化", nil, nil, nil, nil},
    {"%s transmogrified", nil, nil, nil, "%s已成功幻化！", nil, nil, nil, nil},
    {"Selected items are not suitable", nil, nil, nil, "这件装备无法被幻化。", nil, nil, nil, nil},
    {"Selected item does not exist", nil, nil, nil, "选择的装备不存在", nil, nil, nil, nil},
    {"Equipment slot is empty", nil, nil, nil, "该位置没有装备", nil, nil, nil, nil},
    {"You don't have enough %ss", nil, nil, nil, "你没有足够的 %ss", nil, nil, nil, nil},
	{"Transmogrificate", nil, nil, nil, "幻化", nil, nil, nil, nil},
}
